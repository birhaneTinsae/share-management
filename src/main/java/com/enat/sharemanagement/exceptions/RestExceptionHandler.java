...
//        log.info("{} to {}", servletWebRequest.getHttpMethod(), servletWebRequest.getRequest().getServletPath());
    ...
    protected ResponseEntity<Object> handleAccessExpiredJwtException(ExpiredJwtException ex) {
        return buildResponseEntity(new ApiError(UNAUTHORIZED, ex));
    }
    ...
    protected ResponseEntity<Object> handleJobExecutionAlreadyRunningException(JobExecutionAlreadyRunningException ex) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        //  apiError.setMessage(String.format("The parameter '%s' of value '%s' could not be converted to type '%s'", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName()));
        apiError.setMessage(ex.getMessage());
        apiError.setDebugMessage(ex.getMessage());
    ...
    protected ResponseEntity<Object> handleJobInstanceAlreadyCompleteException(JobInstanceAlreadyCompleteException ex) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        //  apiError.setMessage(String.format("The parameter '%s' of value '%s' could not be converted to type '%s'", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName()));
        apiError.setMessage(ex.getMessage());
        apiError.setDebugMessage(ex.getMessage());
    ...
    protected ResponseEntity<Object> handleJobRestartException(JobRestartException ex) {
        ApiError apiError = new ApiError(BAD_REQUEST);
        //  apiError.setMessage(String.format("The parameter '%s' of value '%s' could not be converted to type '%s'", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName()));
        apiError.setMessage(ex.getMessage());
        apiError.setDebugMessage(ex.getMessage());
